...
const VARIABLES = [
  ...
  'STARTING_POINTS_NOT_ON_AUTO_CAPACITY_PLANNING',
  'CROSS_SP_UI_DASHER_AB_SUBMARKET_IDS',
  'CROSS_SP_UI_SUBMARKET_IDS',
  'HOTSPOTS_ZONES_UI_DASHER_AB_SUBMARKET_IDS',
  'HOTSPOTS_ZONES_UI_SUBMARKET_IDS',
]
